...
export const PageBuilder: React.FC<PageBuilderProps> = ({
  ...
  const toolbar = renderToolbar ? (
    renderToolbar({
      isEditMode: pb.isEditMode,
      onToggleEditMode: pb.toggleEditMode,
      onReset: pb.resetLayout,
    })
  ) : (
    <div
      data-pb-toolbar
    ...
    >
      <button data-pb-reset onClick={pb.resetLayout}>
        Reset
      </button>
  ...
  return (
    <div data-pb-root className={classNames.root} style={style}>
      ...
      <div
        ...
        onClick={() => { if (pb.isEditMode) pb.setActiveComponent(null); }}
      >
